...
TwoValueSliderAttachment::TwoValueSliderAttachment(juce::ValueTree const& state, juce::Identifier const& idMin,
                                                   juce::Identifier const& idMax, juce::Slider& slider,

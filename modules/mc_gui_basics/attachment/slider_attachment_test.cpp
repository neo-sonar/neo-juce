...
TEST_CASE("gui_basics/attachment: SliderValueTreeAttachment", "[gui_basics][attachment]")
{
    ...
    auto value       = mc::CachedAtomicFloat {valueTree, juce::Identifier {"value"}, &undoManager};
    value            = 2.0f;

    auto slider     = juce::Slider {"slider"};
    auto attachment = mc::SliderValueTreeAttachment {valueTree, "value", slider, &undoManager};

...
def add_doxygen_group(path, group_name):
    """Add a Doxygen group to the file at 'path'.
       ...
       The addition of mc namespacing code to all of the source files breaks
...
if __name__ == "__main__":
    ...
    for module_name in mc_modules:
        ...
        module_header = os.path.join(module_path, module_name + ".hpp")
        ...
        for subdir in subdirs:
            ...
            module_definiton.append("")
            module_definiton.append(
                "/** @defgroup {tag} {n} */".format(
                    tag=subgroup_name, n=subdir)
            )
        module_definiton.append("")
        module_definiton.append("/** @} */")
    ...
    with open(os.path.join(args.dest_dir, "mc_modules.dox"), "w") as f:
